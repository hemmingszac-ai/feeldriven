...
const features = [
  ...
  },
  {
    ...
    description: "See exactly why each person was selected. Add, remove, or swap candidates on the fly. Check workload availability before you commit.",
    visual: "deploy",
  },
  {
    number: "04",
    title: "Employee intelligence",
    description: "Every employee builds a profile — top strengths, team role, background, working style. The more the platform knows, the stronger the teams it builds.",
    visual: "security",
  },
];
    ...
    >
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 py-12 lg:py-20 border-b border-foreground/10">
        ...
        <div className="flex-1 grid lg:grid-cols-2 gap-8 items-center">
          <div>
            <h3 className="mb-4 text-3xl font-semibold tracking-tight transition-transform duration-500 group-hover:translate-x-2 lg:text-4xl">
              {feature.title}
            </h3>
    ...
    >
      <div className="max-w-350 mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          <h2
            className={`text-4xl font-semibold tracking-tight transition-all duration-700 lg:text-6xl ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
              }`}
          >
            Built for how teams
            <br />
            <span className="text-muted-foreground italic">actually work.</span>
          </h2>
        </div>
